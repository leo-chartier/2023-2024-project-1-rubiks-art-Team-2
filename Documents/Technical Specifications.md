...
- Each Rubik's cube to represent a 3x3 pixel matrix[^8] in colors: Green, Yellow, Red, Orange, Blue, and White.
...
[^4] **Acrylic Panel**: A transparent sheet made of acrylic material, commonly used to protect surfaces or provide a clear barrier.

[^5] **API (Google Spreadsheet)**: The Application Programming Interface provided by Google for interacting with Google Sheets, allowing developers to read and write data.
